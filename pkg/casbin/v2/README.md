...
[![Godoc](https://godoc.org/github.com/casbin/casbin?status.svg)](https://pkg.go.dev/github.com/ndodanli/go-clean-architecture/pkg/casbin/v2)
...
```
go get github.com/ndodanli/go-clean-architecture/pkg/casbin/v2
```
