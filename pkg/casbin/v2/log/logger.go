// Copyright 2018 The casbin_ex Authors. All Rights Reserved.
//
...
//go:generate mockgen -destination=./mocks/mock_logger.go -package=mocks github.com/ndodanli/go-clean-architecture/pkg/casbin/v2/log Logger
