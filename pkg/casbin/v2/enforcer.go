// Copyright 2017 The casbin_ex Authors. All Rights Reserved.
//
...
import (
	...
	"github.com/ndodanli/go-clean-architecture/pkg/casbin/v2/effector"
	"github.com/ndodanli/go-clean-architecture/pkg/casbin/v2/log"
	"github.com/ndodanli/go-clean-architecture/pkg/casbin/v2/model"
	"github.com/ndodanli/go-clean-architecture/pkg/casbin/v2/persist"
	fileadapter "github.com/ndodanli/go-clean-architecture/pkg/casbin/v2/persist/file-adapter"
	"github.com/ndodanli/go-clean-architecture/pkg/casbin/v2/rbac"
	defaultrolemanager "github.com/ndodanli/go-clean-architecture/pkg/casbin/v2/rbac/default-role-manager"
	"github.com/ndodanli/go-clean-architecture/pkg/casbin/v2/util"
...
// File:
//
//	e := casbin_ex.NewEnforcer("path/to/basic_model.conf", "path/to/basic_policy.csv")
//
// MySQL DB:
//
//	a := mysqladapter.NewDBAdapter("mysql", "mysql_username:mysql_password@tcp(127.0.0.1:3306)/")
//	e := casbin_ex.NewEnforcer("path/to/basic_model.conf", a)
